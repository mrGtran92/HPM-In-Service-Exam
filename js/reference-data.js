/* ---------------------------------------------------------------------------
 * REFERENCE MATERIAL shown in the exam's reference window.
 *
 * Not key material: this is what a board candidate is handed, so serving it is
 * safe. It is a plain script (not JSON) so it also loads when index.html is
 * opened straight from Finder.
 *
 * LABS — transcribed from "ABIM Laboratory Test Reference Ranges — January
 * 2026" and checked row by row against the rendered PDF pages. ABIM revises
 * this document every January: redo it from their new PDF before each
 * administration rather than editing values by hand.
 *
 * Format of LAB_TEXT, one row per line:
 *     Test name | value          a row with a value
 *     Test name                  a heading row (its values are indented below)
 *       Sub-row | value          two spaces per level of nesting
 *     + more value text          continues the previous row's value on a new line
 * A row at the left margin starts a new group; the search keeps each group
 * together, so "PaCO2" still shows under "Arterial blood gas studies".
 * ------------------------------------------------------------------------- */

const REFERENCE = {

  labsSource: 'ABIM Laboratory Test Reference Ranges — January 2026',

  /* Transcribed exactly from the program's equianalgesic table. The rows are
   * equivalent amounts, not a dosing schedule: 30 mg oral morphine per day
   * ≈ 12.5 mcg/hr transdermal fentanyl. */
  equianalgesic: {
    columns: ['Drug', 'Oral dose (mg)', 'Parenteral dose', 'Transdermal dose'],
    rows: [
      ['Morphine',      '30',  '10 mg',   '--'],
  ...
  /* Common abbreviations a fellow might type into the lab search. Each maps to
   * text that appears in the matching test name. */
  labAliases: {
    na: 'sodium', k: 'potassium', cl: 'chloride', hco3: 'bicarbonate',
    cr: 'creatinine', bun: 'urea nitrogen', mg: 'magnesium', ca: 'calcium',
    phos: 'phosphorus', hgb: 'hemoglobin', hb: 'hemoglobin', hct: 'hematocrit',
    wbc: 'leukocyte', rbc: 'erythrocyte', plt: 'platelet', inr: 'prothrombin',
    pt: 'prothrombin', ptt: 'partial thromboplastin', tsh: 'thyroid-stimulating',
    abg: 'arterial blood gas', vbg: 'venous studies', bnp: 'natriuretic',
    ldh: 'lactate dehydrogenase', alt: 'alanine', ast: 'aspartate',
    alp: 'alkaline phosphatase', ggt: 'gamma-glutamyl', crp: 'c-reactive',
    esr: 'sedimentation', a1c: 'hemoglobin a1c', ck: 'creatine kinase',
    lft: 'aminotransferase', osm: 'osmolality', b12: 'vitamin b12',
  },
};

REFERENCE.LAB_TEXT = `
1,25-Dihydroxyvitamin D (1,25-dihydroxycholecalciferol), serum | See Vitamin D metabolites
...
25-Hydroxyvitamin D (25-hydroxycholecalciferol), serum | See Vitamin D metabolites
5-Hydroxyindoleacetic acid, urine | 2–9 mg/24 hr
5'-Nucleotidase, serum | 0.3–2.6 (Bodansky) units/dL (0–15 U/L)
6-Thioguanine, whole blood | 230–400 pmol/8×10⁸ RBCs
...
Alpha₁-antitrypsin (AAT), serum | 150–350 mg/dL
Alpha₂-antiplasmin activity, plasma | 75%–115%
...
Anti-phospholipase A2 receptor (PLA2R) antibodies, serum [ELISA] | Negative: <14 RU/mL
...
Anti-Scl-70 antibodies (topoisomerase 1 antibodies), IgG, serum | Negative: <1.0 U
+ [Positive: ≥1.0 U]
...
Beta₂-glycoprotein I antibodies:
  IgG | <21 SGU
  IgM | <21 SMU
Beta-hydroxybutyrate, serum | <0.4 mmol/L
Beta₂-microglobulin, serum | 0.54–2.75 mg/L
...
Calcium, ionized, serum | 1.16–1.31 mmol/L
...
Chorionic gonadotropin, beta-human (beta-hCG), serum | See Beta-human chorionic gonadotropin (beta-hCG), serum
Chorionic gonadotropin, beta-human (beta-hCG), urine | See Beta-human chorionic gonadotropin (beta-hCG), urine
...
Creatinine clearance, urine | 90–140 mL/min/1.73 m²
...
D-Xylose absorption (after ingestion of 25 g of D-xylose)
  Serum | 25–40 mg/dL
...
Erythrocyte survival rate (⁵¹Cr) | T½ = 28 days
...
Gamma-glutamyltransferase (gamma-glutamyl transpeptidase), serum | Female: 8–40 U/L; male: 9–50 U/L
...
Osmolality, serum | 275–295 mOsm/kg H₂O
Osmolality, urine | 38–1400 mOsm/kg H₂O
...
Platelet survival rate (⁵¹Cr) | 10 days
...
Pressure (opening) [initial], CSF | 70–180 mm CSF (70–180 mm H₂O); 7–18 cm H₂O
...
Thyroid function studies
  ...
  Thyroidal iodine (¹²³I) uptake | 5%–30% of administered dose at 24 hours
...
Vitamin D metabolites, serum
  1,25-Dihydroxyvitamin D (1,25-dihydroxycholecalciferol) | 15–60 pg/mL
  25-Hydroxyvitamin D (25-hydroxycholecalciferol) | 30–60 ng/mL
Vitamin E, serum:
  Adult | 5.5–17.0 mg/L
...
von Willebrand factor activity (ristocetin cofactor activity), plasma | 50%–150%
